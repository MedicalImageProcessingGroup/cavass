...
void master(char* in, char*out)
{
  ...
  filter_data = (unsigned short*)malloc(volume_size*sizeof(unsigned short));
 ...
 */ 
  ...
  error_code = VWriteData((char*)filter_data, num_of_bits/8, volume_size, fp, &j);  
  fclose(fp);
