...
//======================================================================
/**
 * \file   ITKFilterCanvas.h
 * \brief  ITKFilterCanvas definition.
 ...
 */
//======================================================================
#ifndef __ITKFilterCanvas_h
#define __ITKFilterCanvas_h
 ...
 */
class ITKFilterCanvas : public MainCanvas {
...
public:
    ...
    wxImage*          mImages[2];        ///< images for displayed slices (unfiltered & filtered slice)
    wxBitmap*         mBitmaps[2];       ///< bitmaps for displayed slices (unfiltered & filtered slice)
...
protected:
    ...
    double            mScale;            ///< scale for both directions for all images
    ...
    // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  public:
    ITKFilterCanvas ( void );
    ITKFilterCanvas ( wxWindow* parent, MainFrame* parent_frame, wxWindowID id,
  ...
  public:
	...
	double getScale    ( const int which ) const;
    ...
    void   setScale    ( const int which, const double scale );
    // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    DECLARE_DYNAMIC_CLASS(ITKFilterCanvas)
    DECLARE_EVENT_TABLE()
};
