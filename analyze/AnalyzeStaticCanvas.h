...
//======================================================================
/**
 * \file   AnalyzeStaticCanvas.h
 * \brief  AnalyzeStaticCanvas definition.
 ...
 */
//======================================================================
#ifndef __AnalyzeStaticCanvas_h
#define __AnalyzeStaticCanvas_h
...
//class AnalyzeStaticCanvas : public wxScrolledWindow {
/** \brief AnalyzeStaticCanvas - the canvas on which images and other things
 *  are drawn (i.e., the drawing area of the window).
 */
class AnalyzeStaticCanvas : public MainCanvas 
{
  int  mOverallXSize, mOverallYSize, mOverallZSize;
                                         ///< max count of pixels of displayed images in x,y,z  
  bool           m_bAnalyzeStaticDone;
  int            m_nROIType;
  int            m_nGradType;
...
protected:
  //static const int sSpacing;           ///< space, in pixels, between each slice (on the screen)
    ...
    // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
public:
    AnalyzeStaticCanvas ( void );
    AnalyzeStaticCanvas ( wxWindow* parent, MainFrame* parent_frame, wxWindowID id,
...
public:
  ...
  bool   getAnalyzeStaticDone(void) const;
  ...
  void   setAnalyzeStaticDone(bool done)
  {
    m_bAnalyzeStaticDone = done;
  }  
