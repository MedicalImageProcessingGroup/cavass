...
//======================================================================
/**
 * \file   InterpolateCanvas.h
 * \brief  InterpolateCanvas definition.
 ...
 */
//======================================================================
#ifndef __InterpolateCanvas_h
#define __InterpolateCanvas_h
 ...
 */
class InterpolateCanvas : public MainCanvas {
...
protected:
    ...
    // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
public:
    InterpolateCanvas ( void );
    InterpolateCanvas ( wxWindow* parent, MainFrame* parent_frame,
...
public:
    ...
    void OnLeftUp     ( wxMouseEvent& unused );
    void OnMiddleDown ( wxMouseEvent& unused );
    void OnMiddleUp   ( wxMouseEvent& unused );
    void OnMouseMove  ( wxMouseEvent& e );
    void OnMouseWheel ( wxMouseEvent& e );
    void OnPaint      ( wxPaintEvent& unused );
    void OnRightDown  ( wxMouseEvent& unused );
    void OnRightUp    ( wxMouseEvent& unused );
    ...
    // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    DECLARE_DYNAMIC_CLASS(InterpolateCanvas)
    DECLARE_EVENT_TABLE()
};
