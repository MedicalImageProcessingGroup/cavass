 ...
 */
//======================================================================
#ifndef __ExportCanvas_h
#define __ExportCanvas_h
 ...
 */
class ExportCanvas : public MainCanvas {
...
protected:
  ...
  public:
    ExportCanvas ( void );
    ExportCanvas ( wxWindow* parent, MainFrame* parent_frame, wxWindowID id,
  ...
  public:
    ...
    // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    DECLARE_DYNAMIC_CLASS(ExportCanvas)
    DECLARE_EVENT_TABLE()
};
