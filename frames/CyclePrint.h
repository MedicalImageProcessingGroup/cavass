...
/**
 * \file   CyclePrint.h
 * \brief  CyclePrint definition and implementation
 ...
 */
//======================================================================
#ifndef __CyclePrint_h
#define __CyclePrint_h
...
/** \brief CyclePrint definition and implementation.
 */
class CyclePrint : public wxPrintout {
  protected:
    CycleCanvas*  mCanvas;

  public:
    CyclePrint ( const wxChar* const title = _T("Overlay"), CycleCanvas* mc = NULL )
