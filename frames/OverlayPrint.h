...
/**
 * \file   OverlayPrint.h
 * \brief  OverlayPrint definition and implementation.
 ...
 */
//======================================================================
#ifndef __OverlayPrint_h
#define __OverlayPrint_h

#include  "wx/print.h"
#include  "wx/printdlg.h"
#include  "OverlayCanvas.h"

/** \brief OverlayPrint class definitiion and implementation. */
class OverlayPrint: public wxPrintout {
  protected:
    OverlayCanvas*  m_canvas;  ///< overlay canvas that is drawn

  public:

    OverlayPrint ( const wxChar* const title = _T("Overlay"), OverlayCanvas* mc = NULL )
