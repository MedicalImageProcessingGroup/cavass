...
//======================================================================
/**
 * \file   SurfViewPrint.h
 * \brief  SurfViewPrint definition and implementation.
 ...
 */
//======================================================================
#ifndef __SurfViewPrint_h
#define __SurfViewPrint_h

#include  "wx/print.h"
#include  "wx/printdlg.h"
#include  "SurfViewCanvas.h"
/** \brief SurfViewPrint class definitiion and implementation. */
class SurfViewPrint: public wxPrintout {
  protected:
    SurfViewCanvas*  m_canvas;  ///< overlay canvas that is drawn

  public:

    SurfViewPrint ( const wxChar* const title = _T("SurfView"), SurfViewCanvas* mc = NULL )
