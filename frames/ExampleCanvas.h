 ...
 * \brief  ExampleCanvas definition.
 ...
 */
class ExampleCanvas : public MainCanvas {
...
protected:
  ...
  public:
    ExampleCanvas ( void );
    ExampleCanvas ( wxWindow* parent, MainFrame* parent_frame, wxWindowID id,
  ...
  public:
    ...
    // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    DECLARE_DYNAMIC_CLASS(ExampleCanvas)
    DECLARE_EVENT_TABLE()
};
