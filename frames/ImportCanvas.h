 ...
 */
//======================================================================
#ifndef __ImportCanvas_h
#define __ImportCanvas_h
 ...
 */
class ImportCanvas : public MainCanvas {
...
protected:
  ...
  public:
    ImportCanvas ( void );
    ImportCanvas ( wxWindow* parent, MainFrame* parent_frame, wxWindowID id,
  ...
  public:
    ...
    // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    DECLARE_DYNAMIC_CLASS( ImportCanvas )
    DECLARE_EVENT_TABLE()
};
