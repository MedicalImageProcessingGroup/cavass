 ...
 */
//======================================================================
#ifndef __VOIIOICanvas_h
#define __VOIIOICanvas_h
...
//class VOIIOICanvas : public wxScrolledWindow {
/** \brief VOIIOICanvas - the canvas on which images and other things
 *  are drawn (i.e., the drawing area of the window).
 */
class VOIIOICanvas : public MainCanvas 
{
  ...
  int            m_VOIIOIGraphLeft;
  int            m_VOIIOIGraphTop;
  int            m_VOIIOIGraphRight;
  int            m_VOIIOIGraphBottom;
...
public:
    VOIIOICanvas ( void );
    VOIIOICanvas ( wxWindow* parent, MainFrame* parent_frame, wxWindowID id,
...
public:
  ...
  float normal(float x, float sigma);
    ...
    DECLARE_DYNAMIC_CLASS(VOIIOICanvas)
    DECLARE_EVENT_TABLE()
};
